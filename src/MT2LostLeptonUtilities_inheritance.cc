...
MT2SingleLLEstimateBase::MT2SingleLLEstimateBase( const MT2SingleLLEstimateBase& rhs ) : MT2RegionAnalysisBase( rhs ){
...
MT2SingleLLEstimateBase::MT2SingleLLEstimateBase( const std::string& aname, const MT2Region& aregion ) :  MT2RegionAnalysisBase( aname, aregion ){
...
MT2SingleLLEstimate::MT2SingleLLEstimate( const MT2SingleLLEstimate& rhs ) : MT2SingleLLEstimateBase( MT2SingleLLEstimateBase::rhs.name, *(MT2SingleLLEstimateBase::rhs.region) ) {
...
MT2SingleLLEstimate::MT2SingleLLEstimate( const std::string& aname, const MT2Region& aregion ) : MT2SingleLLEstimateBase( MT2SingleLLEstimateBase::aname, MT2SingleLLEstimateBase::aregion ) {
