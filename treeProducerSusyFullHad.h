...
// Wed Sep 10 12:18:04 2014 by ROOT version 5.32/00
// from TTree treeProducerSusyFullHad/treeProducerSusyFullHad
// found on file: /scratch/mmasciov/QCD_Pt300to470_PU_S14_POSTLS170_babytree.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Float_t         GenP6StatusThree_pt[10];   //[nGenP6StatusThree]
   Float_t         GenP6StatusThree_eta[10];   //[nGenP6StatusThree]
   Float_t         GenP6StatusThree_phi[10];   //[nGenP6StatusThree]
   Float_t         GenP6StatusThree_mass[10];   //[nGenP6StatusThree]
   Int_t           GenP6StatusThree_pdgId[10];   //[nGenP6StatusThree]
   Float_t         GenP6StatusThree_charge[10];   //[nGenP6StatusThree]
   Int_t           GenP6StatusThree_motherId[10];   //[nGenP6StatusThree]
   Int_t           GenP6StatusThree_grandmaId[10];   //[nGenP6StatusThree]
   Int_t           nGenLep;
...
//   if (tree == 0) {
//      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/scratch/mmasciov/QCD_Pt300to470_PU_S14_POSTLS170_babytree.root");
//      if (!f || !f->IsOpen()) {
//         f = new TFile("/scratch/mmasciov/QCD_Pt300to470_PU_S14_POSTLS170_babytree.root");
//      }
