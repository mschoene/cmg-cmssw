...
class Jet(PhysicsObject):   
    ...
    def jetID(self,name=""):
        ...
        if name == "POG_PFID":  
            #MG commented if   self.jetID("POG_PFID_TightLepVeto")  : return 6;
            ...
            #elif self.jetID("POG_PFID_Medium") : return 2;  commented this line because this working point doesn't exist anymore (as 12/05/15)u
            elif self.jetID("POG_PFID_Loose")  : return 1;
            #no longer recommended as of Spring2018           elif self.jetID("POG_PFID_Loose")  : return 1;
            else                               : return 0;
